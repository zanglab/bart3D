...
import os,sys
from bart3d import OptValidator, get_differential_score_per_bin, differential_score_on_UDHS, AUCcalc, StatTest
...
def run_bart3d(options):
    ...
    sys.stdout.flush()
    args.diff_file = get_differential_score_per_bin.differential_score(args)  
